      ...
      <div class="container"> 
        ...
        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
			...
			<li><a class="page-scroll" href="login_id.php"><b>Login</b></a></li>
			<li><a class="page-scroll" href="sign_up.php">Sign Up</a></li>
			<li><a class="page-scroll" href="Adminlogin.php"><b>ADMIN</b></a></li>
          </ul>
        </div>
      </div>
    </nav>
