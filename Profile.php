...
if($stmt = mysqli_prepare($link, $sql)){
    ...
    mysqli_stmt_bind_param($stmt, "iiss",$C_ID ,$booking, $Date, $Time);
      ...
      <div class="container"> 
        ...
        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li onclick="box1();"><a class="page-scroll" href="#"  >ADD Booking</a></li>
            <li><a class="page-scroll" href="Update.php">Edit Booking</a></li>
